...
from Spatialvx import make_SpatialVx   #导入makeSpatialVx函数
from Spatialvx import data_pre
import time
...
def featureFinder(Object, thresh, smoothpar, minsize, smoothfun = "disk2dsmooth", dosmooth = True, 
                  smoothfunargs = None, idfun = "disjointer", maxsize = float("Inf"), fac = 1, zerodown = False, 
                  timepoint = 1,obs = 1, model = 1):
    ...
    out.update({ "Xlabeled":Xlabeled, "Ylabeled":Ylabeled})
